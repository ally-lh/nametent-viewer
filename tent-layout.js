...
export const DEFAULT_LAYOUT = Object.freeze({
  A: Object.freeze({
    text: Object.freeze({ x: 2272, y: 2000, w: 1880, h: 920, size: 900, scale: 1 }),
  }),
  B: Object.freeze({
    text: Object.freeze({ x: 1971, y: 1864, w: 1470, h: 400, size: 340, scale: 1 }),
...
export function serializeLayout(layout) {
  ...
  for (const tent of Object.keys(DEFAULT_LAYOUT)) {
    ...
    for (const key of Object.keys(DEFAULT_LAYOUT[tent])) {
      const { x, y, scale } = layout[tent][key];
      out[tent][key] = { x, y, scale };
    }
  }
